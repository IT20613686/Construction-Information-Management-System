...
export const updateProfile = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post("http://localhost:8070/api/users/profile", user, config);
...
export const deleteProfile = (_id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete("http://localhost:8070/api/users/" + _id, config);
